...
class CheckoutViewController: UIViewController {
    ...
    let stripePublishableKey = "pk_test_sjwi1RASft4usEfXU4oNezLe"
    ...
    let backendBaseURL: String? = "https://safe-journey-54762.herokuapp.com"
    ...
    override func viewDidLayoutSubviews() {
        ...
        imageView.frame = CGRect(x: 0, y: 80, width: self.view.frame.size.width, height: 150)
        ...
        self.paymentRow.frame = CGRect(x: insets.left, y: imageView.frame.maxY + rowHeight,
        ...
        self.title = self.self.productImage.text
    ...
    func paymentContext(_ paymentContext: STPPaymentContext, didCreatePaymentResult paymentResult: STPPaymentResult, completion: @escaping STPErrorBlock) {
        MyAPIClient.sharedClient.completeCharge(paymentResult,
                                                amount: self.paymentContext.paymentAmount, email: UserDefaults.standard.object(forKey: "useremail") as! String, customer: "cus_DqnPIrhdvWsR0a", description: "Product Name: \(self.title!)",
